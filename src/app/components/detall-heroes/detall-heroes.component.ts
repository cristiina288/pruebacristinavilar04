...
@Component({
  selector: 'app-detall-heroes',
  templateUrl: './detall-heroes.component.html',
  styleUrls: ['./detall-heroes.component.css']
})
export class DetallHeroesComponent implements OnInit {
